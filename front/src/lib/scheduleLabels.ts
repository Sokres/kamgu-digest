...
export const SCHEDULE_PRESETS: SchedulePreset[] = [
  {
    id: 'monthly',
    label: 'Раз в месяц',
    description: '1-го числа — снимок за месяц (YYYY-MM)',
    cron: '0 6 1 * *',
  },
  {
    id: 'quarter',
    label: 'Раз в квартал',
    description: '1-го числа в январе, апреле, июле и октябре — снимок за месяц',
    cron: '0 6 1 1,4,7,10 *',
  },
  {
    id: 'weekly',
    label: 'Раз в неделю',
    description: 'Новый снимок за день запуска (YYYY-MM-DD)',
    cron: '0 6 * * 1',
  },
  {
    id: 'daily',
    label: 'Каждый день',
    description: 'Новый снимок каждый день (YYYY-MM-DD) — рекомендуется для трендов',
    cron: '0 6 * * *',
  },
  {
    id: 'custom',
