...
export function AppLayout(props: {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background md:flex-row">
      <aside className="flex shrink-0 flex-col border-b border-sidebar-border bg-sidebar md:sticky md:top-0 md:h-screen md:w-[260px] md:border-b-0 md:border-r">
      ...
      <div className="relative flex min-h-screen min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex min-h-14 shrink-0 flex-wrap items-center gap-3 border-b border-border/60 bg-background/75 px-6 py-3 backdrop-blur-md supports-backdrop-filter:bg-background/55">
